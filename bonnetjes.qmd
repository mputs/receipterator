...
```{python}
def crop_rotate(image, contour_from_middle = True, show_stages = True):
	...
	(l1, l2) = venergy(sobelx, xl,xl, dl, max_iter = 6000, DEBUG=True)
	(r1, r2) = venergy(sobelx, xr,xr, dr, DEBUG=True, alpha = 0.5)
	m1 = (r1+l1)/2
	m2 = (r2+l2)/2
